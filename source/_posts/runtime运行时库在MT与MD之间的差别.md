...
2. 算法
   ...
   - 第一次分配堆块A后
     ...
     ![分配堆块A](runtime运行时在MT与MD之间的差别/image-20210805235444099.png)

   - 第二次分配堆块B后

     ![分配堆块B](runtime运行时在MT与MD之间的差别/image-20210805235657331.png)

   - 第三次分配堆块C后

     ![分配堆块C](runtime运行时在MT与MD之间的差别/image-20210805235933752.png)
